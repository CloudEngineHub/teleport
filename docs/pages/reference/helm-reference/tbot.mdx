...
This chart deploys an instance of the [MachineID](../../machine-workload-identity/introduction.mdx) agent,
...
- The name of a join token configured for Machine ID and your Kubernetes cluster
  as described in the [Machine ID on Kubernetes guide](../../machine-workload-identity/deployment/kubernetes.mdx)
