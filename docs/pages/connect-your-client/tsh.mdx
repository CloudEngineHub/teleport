...
[Machine ID](../machine-workload-identity/machine-workload-identity.mdx). This ensures that your automation
...
[Configure Trusted Clusters](../zero-trust-access/management/admin/trustedclusters.mdx).
