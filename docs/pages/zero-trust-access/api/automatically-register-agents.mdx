...
[servers](../../enroll-resources/auto-discovery/servers/ec2-discovery/ec2-discovery.mdx) on
...
documentation](../../machine-workload-identity/introduction.mdx) to learn more.
